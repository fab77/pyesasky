...
var __gwtModuleFunction = $wnd.esaskyweb_V2_3_B9;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.esaskyweb_V2_3_B9=");
    idx += (13 + "esaskyweb_V2_3_B9".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=esaskyweb_V2_3_B9-0.js
